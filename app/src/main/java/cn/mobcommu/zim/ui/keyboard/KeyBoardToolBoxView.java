...
public class KeyBoardToolBoxView extends RelativeLayout {
     ...
     * 发送表情开关按钮
     */
    @BindView(cn.mobcommu.zim.R.id.keyboard_emotion_button)
    CheckBox mButtonEmotion;
    /**
     * 发送更多类型消息开关按钮
     */
    @BindView(cn.mobcommu.zim.R.id.keyboard_moreFun_button)
    CheckBox mButtonMoreFun;
    /**
     * 切换到语音输入按钮
     */
    @BindView(cn.mobcommu.zim.R.id.keyboard_voice_button)
    CheckBox mButtonVoice;
    /**
     * 发送文本消息按钮
     */
    @BindView(cn.mobcommu.zim.R.id.keyboard_sendText_button)
    Button mButtonSendText;
    /**
     * 文本消息输入框
     */
    @BindView(cn.mobcommu.zim.R.id.keyboard_input_editText)
    EditText mInputEditText;
    /**
     * 语音录音按钮
     */
    @BindView(cn.mobcommu.zim.R.id.keyboard_record_voice_button)
    ...
    private void initView(Context context) {
        ...
        inflate(context, cn.mobcommu.zim.R.layout.chat_keyboard_toolbox_layout, this);
