 ...
 *      complete}
 */
public class FragmentSaveStateTabHost extends TabHost
    ...
    private int mPromotedTabId = Integer.MIN_VALUE;
    ...
    public FragmentSaveStateTabHost(Context context) {
    ...
    public FragmentSaveStateTabHost(Context context, AttributeSet attrs) {
        super(context, attrs);
