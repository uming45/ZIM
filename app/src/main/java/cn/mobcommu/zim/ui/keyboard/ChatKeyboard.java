package cn.mobcommu.zim.ui.keyboard;
...
import cn.mobcommu.zim.ui.RecordingVoiceView;
import cn.mobcommu.zim.ui.keyboard.emotion.KeyBoardEmotionView;
import cn.mobcommu.zim.util.RecordVoiceManager;
import cn.mobcommu.ui.BaseKeyboardLayout;
import cn.mobcommu.util.DisplayUtils;
...
public class ChatKeyboard extends BaseKeyboardLayout implements
    ...
    @BindView(cn.mobcommu.zim.R.id.keyboardContentContainer)
    View mKeyboardContentContainer;
    /**
     * 输入框及其他功能布局视图
     */
    @BindView(cn.mobcommu.zim.R.id.keyboard_toolbox_view)
    KeyBoardToolBoxView mToolBoxView;
    /**
     * 选择更多聊天功能布局
     */
    @BindView(cn.mobcommu.zim.R.id.keyboard_more_fun_view)
    KeyBoardMoreFunView mKeyBoardMoreView;
    /**
     * 表情
     */
    @BindView(cn.mobcommu.zim.R.id.keyboard_emotion_view)
    ...
    protected void inflateView(Context context) {
        ...
        inflate(context, cn.mobcommu.zim.R.layout.chat_keyboard_layout, this);
