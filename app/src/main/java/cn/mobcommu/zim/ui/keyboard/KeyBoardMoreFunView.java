...
public class KeyBoardMoreFunView extends FrameLayout implements CommonRecyclerView.OnItemClickListener {
    @BindView(cn.mobcommu.zim.R.id.moreFunGridView)
    ...
    private void initView(Context context) {
        ...
        inflate(context, cn.mobcommu.zim.R.layout.chat_keyboard_more_layout, this);
    ...
    class MoreAdapter extends HeaderAndFooterAdapter<MoreFunBean> {
        ...
        public ViewHolder onCreateItemViewHolder(ViewGroup parent, int viewType) {
            ...
            View view = LayoutInflater.from(getContext()).inflate(cn.mobcommu.zim.R.layout.chat_keyboard_more_item_layout, parent, false);
    ...
    class MoreViewHolder extends ViewHolder {
        @BindView(cn.mobcommu.zim.R.id.more_fun_icon)
        ImageView mImageView;
        @BindView(cn.mobcommu.zim.R.id.more_fun_name)
        TextView mTextView;
