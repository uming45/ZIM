...
public class EmotionIndicatorView extends LinearLayout {
    ...
    private void init() {
        ...
        mPointIndicatorSize = getResources().getDimensionPixelSize(cn.mobcommu.zim.R.dimen.dimen_5);
        mMargin = getResources().getDimensionPixelSize(cn.mobcommu.zim.R.dimen.dimen_10);
    }
    ...
    public void initindicator(int pageSize) {
        ...
        for(int i = 0; i < pageSize; i++) {
            ...
            if(i == 0) {
                view.setBackgroundResource(cn.mobcommu.zim.R.drawable.keyboard_emotion_indicator_select_bg);
            } else {
                view.setBackgroundResource(cn.mobcommu.zim.R.drawable.keyboard_emotion_indicator_nomal_bg);
            }
    ...
    public void moveToNextIndicator(int startPosition, int nextPosition) {
        ...
        startIndicator.setBackgroundResource(cn.mobcommu.zim.R.drawable.keyboard_emotion_indicator_nomal_bg);
        nextIndicator.setBackgroundResource(cn.mobcommu.zim.R.drawable.keyboard_emotion_indicator_select_bg);
    }
}
