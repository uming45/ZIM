...
public class ChatPromptDialog implements DialogInterface.OnClickListener {
    ...
    public void show(ContactEntity contactEntity) {
        ...
        String message = String.format(mContext.getString(cn.mobcommu.zim.R.string.chat_dialog_message), contactEntity.getRosterEntry().getName());

        if(mDialog == null) {
            AlertDialog.Builder builder = new AlertDialog.Builder(mContext);
            builder.setTitle(mContext.getString(cn.mobcommu.zim.R.string.chat_dialog_title))
                    .setCancelable(true)
                    .setNegativeButton(mContext.getString(cn.mobcommu.zim.R.string.cancel), this)
                    .setPositiveButton(mContext.getString(cn.mobcommu.zim.R.string.ok), this);
