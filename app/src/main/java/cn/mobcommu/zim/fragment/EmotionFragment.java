...
import cn.mobcommu.zim.adapter.EmotionAdapter;
import cn.mobcommu.zim.ui.keyboard.emotion.EmotionItemClickListener;
import cn.mobcommu.zim.util.EmotionDataHelper;
import cn.mobcommu.zim.ui.keyboard.emotion.EmotionIndicatorView;
import cn.mobcommu.zim.adapter.EmotionViewPagerAdapter;
...
public class EmotionFragment extends BaseEmotionFragment {
    @BindView(cn.mobcommu.zim.R.id.emotionIndicator)
    EmotionIndicatorView mIndicatorView;
    @BindView(cn.mobcommu.zim.R.id.emotionViewPager)
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(cn.mobcommu.zim.R.layout.fragment_emotion_layout, container, false);
