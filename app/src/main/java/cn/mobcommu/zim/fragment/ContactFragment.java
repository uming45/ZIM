...
import cn.mobcommu.zim.bean.ContactMenuEntity;
import cn.mobcommu.zim.ui.ChatPromptDialog;
...
public class ContactFragment extends BaseFragment {
    @BindView(cn.mobcommu.zim.R.id.contactRefreshLayout)
    SwipeRefreshLayout mRefreshLayout;
    @BindView(cn.mobcommu.zim.R.id.indexStickyView)
    ...
    public View getContentView(LayoutInflater inflater, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(cn.mobcommu.zim.R.layout.fragment_contact, null);
    ...
    private IndexHeaderFooterAdapter<ContactMenuEntity> getHeaderMenuAdapter() {
        ...
        String indexValue = getString(cn.mobcommu.zim.R.string.contact_index_menu);
...
//        list.add(new ContactMenuEntity(getString(R.string.contact_grouping), ContactMenuEntity.MenuType.GROUP));
        ...
        IndexHeaderFooterAdapter<ContactMenuEntity> adapter = new IndexHeaderFooterAdapter<ContactMenuEntity>(indexValue, null, list) {
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent) {
                ...
                View view = LayoutInflater.from(mContext).inflate(cn.mobcommu.zim.R.layout.contact_item_view, parent, false);
        ...
        public void onItemClick(View childView, int position, ContactMenuEntity item) {
            ...
            switch (item.getMenuType()) {
                case MULTI_CHAT://群聊
                    break;
                case GROUP:
                    UIUtil.showToast(mContext, cn.mobcommu.zim.R.string.text_function_none);
                    break;
            }
        }
    };
    ...
    public String getTitle() {
        ...
        return getString(cn.mobcommu.zim.R.string.text_contact);
    }
