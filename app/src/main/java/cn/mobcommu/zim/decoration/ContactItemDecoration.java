package cn.mobcommu.zim.decoration;
...
public class ContactItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public ContactItemDecoration() {
        ...
        mDivider = new ColorDrawable(AppContext.getInstance().getResources().getColor(cn.mobcommu.zim.R.color.divider_color));
        mSize = AppContext.getInstance().getResources().getDimensionPixelSize(cn.mobcommu.zim.R.dimen.global_divider_size);
        mLeftMargin = AppContext.getInstance().getResources().getDimensionPixelSize(cn.mobcommu.zim.R.dimen.contact_item_left_margin);
        mRightMargin = AppContext.getInstance().getResources().getDimensionPixelSize(cn.mobcommu.zim.R.dimen.contact_item_right_margin);
    }
